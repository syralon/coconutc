...
func (o *options) register(cmd *cobra.Command) {
	...
	cmd.PersistentFlags().BoolVar(&o.overwrite, "overwrite", false, overwriteUsage)
...
const (
	overwriteUsage = "Force overwrite the generated files if it's true. If overwrite is false, only the files which have generated file header(// Code generated by coconutc. DO NOT EDIT.) will be overwritten." +
		"And you can remove or add the file header to control it."
)
