...
func TestEntBuilder(t *testing.T) {
	...
	eb := NewEntBuilder(WithProtoPackage("example"), WithGoPackage("github.com/syralon/coconut/proto/syralon/example;example"))
...
func TestServiceBuilder(t *testing.T) {
	...
	sb := NewServiceBuilder(
		WithProtoPackage("example"),
		WithGoPackage("github.com/syralon/coconut/proto/syralon/example;example"),
		UsePOSTInList(true),
	)
	eb := NewEntBuilder(
		WithProtoPackage("example"),
